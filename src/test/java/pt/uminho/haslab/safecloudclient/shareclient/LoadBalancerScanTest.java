...
public class LoadBalancerScanTest extends ScanTest {
    ...
    static final Log LOG = LogFactory.getLog(LoadBalancerScanTest.class.getName());

    public LoadBalancerScanTest(int maxBits, List<BigInteger> values) throws Exception {
